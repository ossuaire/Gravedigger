...
Character * CharacterFactory::get(const std::string name) {
  ...
  if (name.compare("Gravedigger")==0) { // Instance of Gravedigger required
    ...
    AStand * stand = new AStand(character, 2.5*thousandMillisec);
    sf::IntRect subSprite1(0,0,100,100); // Stand 1
    sf::IntRect subSprite2(0,100,100,100); // Stand 2
    stand->addSubSprite(subSprite1);
    stand->addSubSprite(subSprite2);
    //    sf::IntRect subSpriteA(100,100,100,100); 
    //    sf::IntRect subSpriteB(200,100,100,100); 
    //    sf::IntRect subSpriteC(300,100,100,100); 
    //    stand->addSubSprite(subSpriteA);
    //    stand->addSubSprite(subSpriteB);
    //    stand->addSubSprite(subSpriteC);
    //    stand->addSubSprite(subSpriteB);
